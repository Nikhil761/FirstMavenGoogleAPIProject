package GoogleAPIMaven.GoogleAPIMaven;
...
import Payload.PostGoogleAPIPayoad;
public class GetPostGoogleAPI {
	...
	public static void main(String[] args) {
		...
		.body(PostGoogleAPIPayoad.addPlace()).when().post("/maps/api/place/add/json")
